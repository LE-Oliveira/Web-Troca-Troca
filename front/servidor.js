...
app.listen(3000, function(){console.log('SERVIDOR WEB na porta 3000');});

//const wss = new WebSocket.Server({ port: 8000 },function (){console.log('O servidor de websockets esta rodando na porta 8000');});
